...
namespace Carp.Core.Architecture
{
    public static class ILOpCodes
    {
        ...
        public static readonly ILOpCode LIND_PTR =
            new ILOpCode(ILCode.LIND_PTR, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode LIND_OBJECT =
            new ILOpCode(ILCode.LIND_OBJECT, (byte) ILOperandType.None | ((byte) ILFlowControl.Next));

        public static readonly ILOpCode LIND_BYTE =
            new ILOpCode(ILCode.LIND_BYTE, (byte) ILOperandType.None | ((byte) FlowControl.Next << 8));

        public static readonly ILOpCode LIND_WORD =
            new ILOpCode(ILCode.LIND_WORD, (byte) ILOperandType.None | ((byte) FlowControl.Next << 8));

        public static readonly ILOpCode LIND_DWORD =
            new ILOpCode(ILCode.LIND_DWORD, (byte) ILOperandType.None | ((byte) FlowControl.Next << 8));

        public static readonly ILOpCode LIND_QWORD = new ILOpCode(ILCode.LIND_QWORD,
            (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode SIND_PTR =
            new ILOpCode(ILCode.SIND_PTR, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode SIND_OBJECT = new ILOpCode(ILCode.SIND_OBJECT,
            (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode SIND_BYTE =
            new ILOpCode(ILCode.SIND_BYTE, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));
        ...
        public static readonly ILOpCode POP = new ILOpCode(ILCode.POP,
            (byte) ILOperandType.Register | ((byte) ILFlowControl.Next << 8));
        ...
        public static readonly ILOpCode PUSHI_DWORD = new ILOpCode(ILCode.PUSHI_DWORD,
            (byte) ILOperandType.ImmediateDword | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode PUSHI_QWORD = new ILOpCode(ILCode.PUSHI_QWORD,
            (byte) ILOperandType.ImmediateQword | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode SX_BYTE =
            new ILOpCode(ILCode.SX_BYTE, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode SX_WORD =
            new ILOpCode(ILCode.SX_WORD, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode SX_DWORD =
            new ILOpCode(ILCode.SX_DWORD, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode CALL = new ILOpCode(ILCode.CALL,
            (byte) ILOperandType.None | ((byte) ILFlowControl.Call << 8));

        public static readonly ILOpCode RET = new ILOpCode(ILCode.RET,
            (byte) ILOperandType.None | ((byte) ILFlowControl.Return << 8));

        public static readonly ILOpCode NOR_DWORD =
            new ILOpCode(ILCode.NOR_DWORD, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));
        ...
        public static readonly ILOpCode CMP_R32 =
            new ILOpCode(ILCode.CMP_R32, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode CMP_R64 =
            new ILOpCode(ILCode.CMP_R64, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode JZ = new ILOpCode(ILCode.JZ,
            (byte) ILOperandType.None | ((byte) ILFlowControl.ConditionalJump << 8));

        public static readonly ILOpCode JNZ = new ILOpCode(ILCode.JNZ,
            (byte) ILOperandType.None | ((byte) ILFlowControl.ConditionalJump << 8));

        public static readonly ILOpCode JMP = new ILOpCode(ILCode.JMP,
            (byte) ILOperandType.None | ((byte) ILFlowControl.Jump << 8));
        ...
        public static readonly ILOpCode ADD_R32 =
            new ILOpCode(ILCode.ADD_R32, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode ADD_R64 =
            new ILOpCode(ILCode.ADD_R64, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode SUB_R32 =
            new ILOpCode(ILCode.SUB_R32, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode SUB_R64 =
            new ILOpCode(ILCode.SUB_R64, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));
        ...
        public static readonly ILOpCode MUL_R32 =
            new ILOpCode(ILCode.MUL_R32, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode MUL_R64 =
            new ILOpCode(ILCode.MUL_R64, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));
        ...
        public static readonly ILOpCode DIV_R32 =
            new ILOpCode(ILCode.DIV_R32, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode DIV_R64 =
            new ILOpCode(ILCode.DIV_R64, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));
        ...
        public static readonly ILOpCode REM_R32 =
            new ILOpCode(ILCode.REM_R32, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode REM_R64 =
            new ILOpCode(ILCode.REM_R64, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode SHR_DWORD = new ILOpCode(ILCode.SHR_DWORD,
            (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));

        public static readonly ILOpCode SHR_QWORD =
            new ILOpCode(ILCode.SHR_QWORD, (byte) ILOperandType.None | ((byte) ILFlowControl.Next << 8));
